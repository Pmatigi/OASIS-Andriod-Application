...
class BookingListAdapterComp(activity: Activity, bookingList: ArrayList<CurrentBooking>?,val itemClickListener: ItemClickListener) : RecyclerView.Adapter<BookingListAdapterComp.MyVewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookingListAdapterComp.MyVewHolder {
    ...
    override fun onBindViewHolder(holder: MyVewHolder, position: Int) {
        ...
        try {
           ...
           // holder.tv_bus_name?.text= bookingList?.get(position)?.b
