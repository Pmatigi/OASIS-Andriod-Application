...
class BoardingListAdapter(activity: Activity,selectedBoardingPos:Int, boardinglist: ArrayList<String>?,busType:String,tour_time:String,val itemClickListener: ItemClickListener) : RecyclerView.Adapter<BoardingListAdapter.MyVewHolder>() {
    ...
    init {
        ...
        selectedPosition = selectedBoardingPos

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoardingListAdapter.MyVewHolder {
