...
class UpperSleeperSeatListAdapter(activity: Activity, seatsCount:Int, busSeats:List<UpperSeat>, val seatClickListener: SeatClickListener, val itemClickListener: ItemClickListener) : RecyclerView.Adapter<UpperSleeperSeatListAdapter.MyVewHolder>() {
    private val context: Context
    var busSeats:List<UpperSeat>?
    var seatsCount=0
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UpperSleeperSeatListAdapter.MyVewHolder {
        ...
        try {
            ...
            seat1ClickListener=seatClickListener
                ...
                if(((4*position+1)-1)>=(busSeats!!.size)) {
                    ...
                    } else if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 1)) {
                        holder.iv_upper_l1.setImageResource(R.drawable.upper_seat_selected)
                    }else{
                ...
                if(((4*position+2)-1)>=(busSeats!!.size)) {
                    ...
                    } else if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 2)) {
                        holder.iv_upper_l2.setImageResource(R.drawable.upper_seat_selected)
                    }else{
                ...
                if(((4*position+3)-1)>=(busSeats!!.size)) {
                    ...
                    } else if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 3)) {
                        holder.iv_upper_l3.setImageResource(R.drawable.upper_seat_selected)
                    }else{
                ...
                if(((4*position+4)-1)>=(busSeats!!.size)) {
                    ...
                    } else if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 4)) {
                        holder.iv_upper_l4.setImageResource(R.drawable.upper_seat_selected)
                    }else{
            ...
            holder.iv_upper_l1.setOnClickListener{
                if(!((busSeats?.size!! > ((4*position+1)-1)) && busSeats?.get((4*position+1)-1)?.isBooked==1)) {
                    if (SeatsActivity.selectedPosListUpperSleeper.contains((4 * position + 1))) {
                        SeatsActivity.selectedPosListUpperSleeper.remove((4 * position + 1))

                        SeatsActivity.selectedSeatListUpperSleeper.remove(busSeats!!.get(4 * position).seatNo)
                        holder.iv_upper_l1.setImageResource(R.drawable.upper_seat)
                    } else {
                        SeatsActivity.selectedPosListUpperSleeper.add(4 * position + 1)
                        SeatsActivity.selectedSeatListUpperSleeper.add(busSeats!!.get(4 * position).seatNo)
            ...
            holder.iv_upper_l2.setOnClickListener{
                if(!((busSeats?.size!! > ((4*position+2)-1)) && busSeats?.get((4*position+2)-1)?.isBooked==1)) {
                    ...
                    if (SeatsActivity.selectedPosListUpperSleeper.contains((4 * position + 2))) {
                        SeatsActivity.selectedPosListUpperSleeper.remove((4 * position + 2))
                        SeatsActivity.selectedSeatListUpperSleeper.remove(busSeats!!.get(4 * position+1).seatNo)

                        holder.iv_upper_l2.setImageResource(R.drawable.upper_seat)
                    } else {
                        SeatsActivity.selectedPosListUpperSleeper.add(4 * position + 2)
                        SeatsActivity.selectedSeatListUpperSleeper.add(busSeats!!.get(4 * position+1).seatNo)
            ...
            holder.iv_upper_l3.setOnClickListener{
                ...
                if(!((busSeats?.size!! > (pos1)) && busSeats?.get(pos1)?.isBooked==1)) {
                    ...
                    if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 3)) {
                        SeatsActivity.selectedPosListUpperSleeper.remove(4 * position + 3)
                        SeatsActivity.selectedSeatListUpperSleeper.remove(busSeats!!.get(4 * position+2).seatNo)

                        holder.iv_upper_l3.setImageResource(R.drawable.upper_seat)
                    } else {
                        SeatsActivity.selectedPosListUpperSleeper.add(4 * position + 3)
                        SeatsActivity.selectedSeatListUpperSleeper.add(busSeats!!.get(4 * position+2).seatNo)
            ...
            holder.iv_upper_l4.setOnClickListener{
                ...
                if(!((busSeats?.size!! > (pos)) && (busSeats?.get(pos)?.isBooked==1))) {
                    ...
                    if (SeatsActivity.selectedPosListUpperSleeper.contains(4 * position + 4)) {
                        SeatsActivity.selectedSeatListUpperSleeper.remove(busSeats!!.get(4 * position+3).seatNo)
                        holder.iv_upper_l4.setImageResource(R.drawable.upper_seat)
                    } else {
                        SeatsActivity.selectedPosListUpperSleeper.add(4 * position + 4)
                        SeatsActivity.selectedSeatListUpperSleeper.add(busSeats!!.get(4 * position+3).seatNo)
                        holder.iv_upper_l4.setImageResource(R.drawable.upper_seat_selected)
                    }
                    seat1ClickListener!!.onClick()
                }else{
